...
class RIB::Protocol::IRC::Connection < RIB::Connection::Base

  Message = Struct.new :prefix, :user, :source, :command, :params, :data
  ...
  def login
    ...
    raise(RIB::LoginError, rpl) unless rpl && rpl.command == "001"
  end
